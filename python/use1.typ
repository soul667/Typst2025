...
#maketitle(
  title: "All you need to know about Python",
  authors: ("1. environment",),
  date: "September 2025",
)
...
= 简介
本章我们将主要围绕Python及其相关的环境配置来展开，简要介绍笔者个人的使用习惯和经验。
```
...
= docker
conda中不仅包含了包管理器，还包含了环境管理器，可以创建独立的python环境，互不干扰。
// == environment
